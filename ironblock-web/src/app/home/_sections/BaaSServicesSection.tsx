...
export function BaaSServicesSection() {
  return (
    <section id="baas" className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
      <div className="max-w-7xl mx-auto">
        <FadeInUp className="text-center mb-16">
          <div className="inline-flex items-center justify-center px-4 py-2 bg-primary-900 rounded-full mb-4">
        ...
        <FadeInUp delay={0.2}>
          <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ScaleIn delay={0.1}>
              <div className="p-6 bg-gray-950 rounded-xl hover:shadow-lg transition">
